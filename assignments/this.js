...
* 2. Implicit Binding - (objects generally) is used the most. When a function is envoked, look to the left of the dot and that is what the `this` keyword references.
